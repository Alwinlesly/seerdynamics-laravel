                    ...
                    <td colspan="3" style="background: #e8f3f4;padding: 30px 50px;font-family: calibri;">
                        <table style="background:#fff;width: 56%;margin: 0 auto;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-weight:bold;padding:10px 20px;">Approved on</td>
                                    <td>{{ htmlspecialchars($ApprovedOn ?? '') }}</td>
                                </tr>
                                <tr>
                                    <td style="font-weight:bold;padding:10px 20px;">Approved By</td>
                                    <td>{{ htmlspecialchars($ApprovedBy ?? '') }}</td>
                                </tr>
                            </tbody>
                        </table>
