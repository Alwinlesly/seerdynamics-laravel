        ...
        <tbody>
            ...
            <tr>
                <td colspan="3">
                    ...
                    <span style="font-size:13px;font-family:calibri;color:#a7a5a5;"> > </span>
                    <span style="font-size:13px;font-family:calibri;color:#a7a5a5;">In process</span>
                    <span style="font-size:13px;font-family:calibri;color:#a7a5a5;"> > </span>
                    <span style="font-size:13px;font-family:calibri;color:#a7a5a5;">Completed</span>
                    <span style="font-size:13px;font-family:calibri;color:#a7a5a5;"> > </span>
                    <span style="font-size: 13px;font-family: calibri;color: #a7a5a5;">Closed</span>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="background: #e8f3f4;padding: 30px 50px;font-family: calibri;">
                    <table style="background:#fff;width: 56%;margin: 0 auto;">
                        <tbody>
                            ...
                            <tr>
                                <td style="font-weight:bold;padding:10px 20px;">Consultant worked</td>
                            ...
                            <tr>
                                <td style="font-weight:bold;padding:10px 20px;">Completed On</td>
                                <td>{{ htmlspecialchars($completed_date ?? '') }}</td>
                            </tr>
                            <tr>
                                <td style="font-weight:bold;padding:10px 20px;">Closed On</td>
