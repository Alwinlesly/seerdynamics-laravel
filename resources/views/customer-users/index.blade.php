...
<div class="main">
    ...
    <div class="row m-0">
        ...
        <div class="right-section col-lg-9 px-0 pb-0">
            <div class="px-4">
                <div class="header">
                    <h1 class="pg-hd"><b>Customer Users</b></h1>
                    <div class="search-create">
                        ...
                        <button class="btn btn-create" data-bs-toggle="modal" data-bs-target="#createCustomerUserModal">
                            <span>
                    ...
                    <div class="table-responsive table-x table-consultant">
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-2 pagination">
                                ...
                                <span class="text-muted">of <span id="totalCustomerUsers">0</span></span>
                                <div class="d-flex">
...
<!-- Include Modals -->
@include('customer-users.modals.create')
@include('customer-users.modals.edit')
@include('customer-users.modals.delete')
...
$(document).ready(function() {
    ...
    function renderCustomerUsers(customerUsers) {
        const tbody = $('#customerUsersTableBody');
        tbody.empty();
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center gap-2 con_name">
                            ${avatarHtml}
                            <span class="fw-medium">${cuser.name}</span>
                        </div>
                    </td>
                    <td>${cuser.email}</td>
                    <td>${cuser.mobile}</td>
    ...
    $(document).on('click', '.edit-customer-user', function() {
        ...
        $.ajax({
            url: `/users/client/${cuserId}/edit`,
            method: 'GET',
            success: function(response) {
                if (!response.error) {
                    const cuser = response.customer_user;
